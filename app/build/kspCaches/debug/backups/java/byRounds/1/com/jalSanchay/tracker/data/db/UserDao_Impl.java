  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`name`,`email`,`passwordHash`,`city`,`householdSize`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(6, entity.getHouseholdSize());
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`name` = ?,`email` = ?,`passwordHash` = ?,`city` = ?,`householdSize` = ?,`createdAt` = ? WHERE `id` = ?";
      }
    ...
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<User>() {
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfHouseholdSize = CursorUtil.getColumnIndexOrThrow(_cursor, "householdSize");
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpHouseholdSize;
            _tmpHouseholdSize = _cursor.getString(_cursorIndexOfHouseholdSize);
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new User(_tmpId,_tmpName,_tmpEmail,_tmpPasswordHash,_tmpCity,_tmpHouseholdSize,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
